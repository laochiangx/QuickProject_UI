 ...
 this.$nextTick(() => {
      ...
      this.nowDate = `${month}-${day} ${hour}:${minute}:${second}`;
        ...
        systemInfoApi.getOverView().then(res => {
          if(res.data)
          {//res.data.metaSpace
              this.datas.push(parseFloat(res.data.heapMemoryUsage.committed/1024/1024).toFixed(2)) ;
              this.datass.push(parseFloat(res.data.heapMemoryUsage.used/1024/1024).toFixed(2));
              this.data3.push(parseFloat(res.data.heapMemoryUsage.init/1024/1024).toFixed(2));
              this.data4.push(parseFloat(res.data.heapMemoryUsage.max/1024/1024/10).toFixed(2));
    ...
    initChart() {
      ...
      this.chart.setOption({
        ...
        legend: {
          ...
          itemHeight: 5,
          itemGap: 13,
          data: ['committed（M）', 'used（M）','init（M）','max（DM）'],
          right: '4%',
          textStyle: {
            fontSize: 12,
            color: '#000000'
