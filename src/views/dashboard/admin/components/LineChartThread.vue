 ...
 this.$nextTick(() => {
      ...
      this.nowDate = `${month}-${day} ${hour}:${minute}:${second}`;
        ...
        systemInfoApi.getOverView().then(res => {
          if(res.data)
          {//res.data.metaSpace
              this.datas.push(parseFloat(res.data.threadInfo.totalStartedThreadCount)) ;
              this.datass.push(parseFloat(res.data.threadInfo.liveThreadCount));
              this.data3.push(parseFloat(res.data.threadInfo.livePeakThreadCount));
              this.data4.push(parseFloat(res.data.threadInfo.daemonThreadCount));
